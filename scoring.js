...
$(document).ready(function(){
  ...
  function score_indicate(){
    ...
    // 「平均点：」(id="average_indicate")に変数「average」(平均点)を出力させます。
  ...
  function judgement(){
    ...
    // 以前にすでに最終ジャッジが出力されていた場合、表示(id="alert-indicate")が重複しないよう削除します。
    $('#alert-indicate').remove();
    // 「最終ジャッジ」(id="btn-declaration")ボタンを押したら「あなたの成績は${achievement}で${pass_or_failure}です」が出力される処理です。
  ...
  // 「ランク」(id="btn-evaluation")ボタンを押したら「get_achievement()」が出力される処理です。
